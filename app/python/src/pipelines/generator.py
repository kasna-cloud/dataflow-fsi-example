...
def setup_parser(parser):
	parser.add_argument(
		"--output_prices_topic",
		required=True,
		help=("PubSub topic to publish the generated prices to. A string in the form of "
	...
	parser.add_argument(
		...
		default=10,
		type=int,
		help=("Rate to which to tick the price generator. Note that due to in-built gap "
			"generation, the number of prices output per second will be less than the " "tick rate.")
	)
	parser.add_argument(
		'--timestamp_key',
		default="timestamp",
